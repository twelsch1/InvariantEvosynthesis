...
public class SimpleEvaluatorWithVerification extends Evaluator
    {
    /**
	 * 
	 */
	private static final long serialVersionUID = 8062791850127445481L;
    ...
    public void evaluatePopulation(final EvolutionState state)
        ...
        if (state.evalthreads == 1)
            ...
            ((CLIAProblem)prob).postEvaluation(state,0);
