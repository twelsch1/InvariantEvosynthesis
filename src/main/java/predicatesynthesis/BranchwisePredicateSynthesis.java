...
import predicatesynthesis.helpers.ExtractInductiveLemmas;
...
public class BranchwisePredicateSynthesis {
	...
	public SynthesisResult run(Benchmark benchmark, Synthesizer predicateSynthesizer, boolean verifySuccess,
