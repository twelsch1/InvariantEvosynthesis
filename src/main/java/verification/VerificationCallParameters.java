...
public class VerificationCallParameters {
	 ...
	 */
	private ArrayList<TestExample> counterExamples = null;
	/**
	...
	public VerificationCallParameters(ArrayList<TestExample> counterExamples, int timeout, int threads, Context context) {
	...
	public VerificationCallParameters(ArrayList<TestExample> counterExamples, int timeout, int threads) {
		this.counterExamples = counterExamples;
		this.timeout = timeout;
		this.threads = threads;
	}
	...
	public void setCounterExamples(ArrayList<TestExample> counterExamples) {
		this.counterExamples = counterExamples;
	}
